...
from src.main import cli, convert, main
...
class TestConfigCommand:
    ...
    def test_config_validate_nonexistent_file(self) -> None:
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['config', 'validate', '--config', 'nonexistent.toml'])
        ...
        try:
            ...
            with patch('src.main.PDFGenerator') as mock_generator:
                with patch('src.excel_processor.ExcelReader') as mock_reader:
                    ...
                    mock_reader.return_value.__enter__.return_value.discover_sheets.return_value = ['Sheet1']
